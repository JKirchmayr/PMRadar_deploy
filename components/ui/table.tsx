...
>(({ className, ...props }, ref) => (
  <table
    ref={ref}
    className={cn(
      "relative w-full overflow-auto caption-bottom text-xs",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-8 px-4 text-left align-middle font-medium text-gray-500 [&:has([role=checkbox])]:pr-0 dark:text-gray-400",
      className,
    )}
    {...props}
  />
